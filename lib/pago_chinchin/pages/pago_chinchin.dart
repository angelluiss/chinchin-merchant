...
class PagoChinchinPage extends StatefulWidget {
  PagoChinchinPage({Key? key}) : super(key: key);

  @override
  _PagoChinchinPageState createState() => _PagoChinchinPageState();
}

class _PagoChinchinPageState extends State<PagoChinchinPage> {
  @override
